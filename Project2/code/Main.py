...
while True:
    ...
    counter_message_id = int(result[0][0]) + 1 if result[0][0] is not None else 0
    try:
    ...
    if command[0] == 'login':
        ...
        query4 = "INSERT INTO Message Values ('" + result[0][0] + " left group','" + str(time) + "','" + str(
...
#KOOOOOOOOSHAAAAAAAAAAAAAAAA
        ...
        for y in group_id:
            ...
            query4 = "INSERT INTO Message Values ('" + result[0][0] + " joined group','" + str(time) + "','" + str(counter_message_id) + "','SYS','" + str(date) + "')"
            cursor.execute(query4)
            db.commit()
        ...
        if len(result) == 0:
            ...
            if len(res) == 0:
                ...
                for x in result:
                    ...
                    print('Name:' + '\"' + x[0] + '\"' + ' MembersCount:' + str(mem_count[0][0]) + ' Link:' + '\"' + x[1] + '\"' + ' Creator:' + '\"' + x[2] + '\"', end = " ")
